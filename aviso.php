...
<?php retornoadmin();?>
<h1>Agregar Aviso</h1>
<form style="width:75%;" action="aviso.php" method="POST" style="margin-top: 10px;">
	<div class="formulario2">
	<span><b>Seleccionar Usuario:</b></span>
<select style="width:100%;margin:auto;text-align:center;" name="sitio">
<?php
$query2="SELECT * FROM aviso WHERE estatus='0' ORDER BY nombre ASC";
$resultado2=mysqli_query($sgstec,$query2);
while ($row2 = mysqli_fetch_array($resultado2)):;
?>
<option value="<?php echo $row2[3]; ?>"><?php echo $row2[1]." ".$row2[2]; ?></option>
<?php endwhile; ?>
</select>
	</div><br><br>
	<div>
		<p><input class="enviar" type="submit" value="Activar"></p>
	</div>
</form>
...
mysqli_query("UPDATE aviso SET estatus='1' WHERE cedula='$cedula'");
echo "El usuario de cedula: ".$cedula." ha sido agregado al listado de avisos";
