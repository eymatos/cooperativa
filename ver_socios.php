...
">
<?php retornoadmin();
echo '<div><form class="navbar-form" name="buscar" action="excel.php"  method="get" style="position: inherit;
    float: right;
    width: 100px;">
<div class="form-group input-group" style="text-align: center;">
<select name="contrato"><option value="F">Fijo</option><option value="C">Contratado</option><option value="P">Pension</option></select>

 <button type="submit" name="buscar" value="Buscar" class="btn" style="font-size: 20px;
    color: white ;
    background: #009A00;">
   <span>Descargar</span>
   </button>
...
echo "<td style='padding: 5px;'><b>Nombre</b></td>";
echo "<td style='padding: 5px;'><b>Apellido</b></td>";
echo "<td style='padding: 5px;'><b>Fecha de Inscripción</b></td>";
echo "<td style='padding: 5px;'><b>Monto Ahorrado</b></td>";
echo "<td style='padding: 5px;'><b>Monto Ahorrado Retirable</b></td>";
...
echo "<td style='padding: 5px;'>".$apellido."</td>";
echo "<td style='padding: 5px;'>".$fecha."</td>";
