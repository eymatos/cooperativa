...
mysql_query("INSERT INTO ".$sitio2." (cedula, monto, interes, plazo, numero_prestamo, fecha_prestamo, primera_cuota, total_pagar, tipo, desembolso, prestamo_anterior) VALUES ('".$cedula."', '".$monto."', '".$interes."', '".$plazo."', '".$numero_prestamo."','".$fecha_prestamo."', '".$primera_cuota."', '".$total_pagar."', '".$sitio2."', '".$desembolso."', '".$prestamo_anterior."')");
