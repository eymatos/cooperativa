...
$server_link = mysql_connect("localhost", "cooproco_n", "procon01");mysql_query("SET NAMES 'utf8'");mysql_set_charset('utf8');
if(!$server_link){
    die("Falló la Conexión ". mysqli_error());
}
// seleccionamos la base de datos
$db_selected = mysql_select_db("cooproco_n", $server_link);
if(!$db_selected){
...
mysql_set_charset('utf8');
    $totalRows = mysql_num_rows($resultado2);
    // Enviamos un mensaje
