...
if(isset($medu)){$medu = $medu;} else {$medu = 0;}
if(isset($mmadres)){$mmadres = $mmadres;} else {$mmadres = 0;}
if(isset($mesco)){$mesco = $mesco;} else {$mesco = 0;}
if(isset($mnor)){$mnor = $mnor;} else {$mnor = 0;}
if(isset($mvac)){$mvac = $mvac;} else {$mvac = 0;}
if(isset($mger)){$mger = $mger;} else {$mger = 0;}
