        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('admin.socios.store') }}" class="bg-white p-8 rounded-lg shadow-md border-t-4 border-blue-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block font-medium text-sm text-gray-700">Contraseña para el Socio</label>
                        <input type="password" name="password" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>
