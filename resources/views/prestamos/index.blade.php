<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('prestamos.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                + Nuevo Préstamo
            </a>
        </div>
    </x-slot>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">{{ $prestamo->plazo }} meses</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('prestamos.show', $prestamo) }}" class="text-indigo-600 hover:text-indigo-900">Ver Tabla</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
