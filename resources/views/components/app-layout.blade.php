                                ...
                                @auth
                                    @if(Auth::user()->tipo == 2)
                                        ...
                                        <div class="inline-flex items-center px-1 pt-1 relative" x-data="{ openMigrar: false }">
                                            ...
                                            <div x-show="openMigrar" style="display: none;" class="absolute top-full left-0 w-64 bg-white rounded-2xl shadow-2xl py-2 mt-2 border border-gray-100 z-50">
                                ...
                                @auth
                                    @if(Auth::user()->tipo == 0)
                                        <div class="inline-flex items-center px-1 pt-1 relative" x-data="{ openServicios: false }">
                                            ...
                                            <div x-show="openServicios" style="display: none;" class="absolute top-full left-0 w-56 bg-white rounded-2xl shadow-2xl py-2 mt-2 border border-gray-100 z-50">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            @auth
                                <div class="ml-3 relative" x-data="{ openUser: false }">
                                    ...
                                    <div x-show="openUser" @click.away="openUser = false" style="display: none;" class="absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-lg py-1 ring-1 ring-black ring-opacity-5 z-50 overflow-hidden">
