...
<form style="width:75%;" action="crearusuario.php" method="POST" style="margin-top: 10px;">
	...
	<div class="formulario2">
		...
		<span style="width:100%;"><input type="text" name="guia_reti"></span>
	</div>
		<br><br>
			<div class="formulario2">
...
echo "Usted ha seleccionado de cédula $cedula";
if($cedula)
{	
mysqli_query($sgstec,"INSERT INTO usuarios (cedula, nombre, apellido, sexo, email, clave, fecha_inscripcion, inscripcion, aporte_capital, ahorro_retirable, guia, guia_reti, contrato, estatus) VALUES ('".$cedula."', '".$nombre."', '".$apellido."', '".$sexo."', '".$email."','221a80702357fde0038a276221330754', '".$fecha_inscripcion."', '".$inscripcion."', '".$aporte_capital."', '".$ahorro_retirable."', '".$guia."', '".$guia_reti."', '".$contrato."', '1')");

//mysqli_query($sgstec,"INSERT INTO usuarios (cedula, nombre, apellido, sexo, email, clave, fecha_inscripcion, inscripcion, aporte_capital, ahorro_retirable, guia, guia_reti,contrato) VALUES ('".$cedula."', '".$nombre."', '".$apellido."', '".$sexo."', '".$email."','221a80702357fde0038a276221330754', '".$fecha_inscripcion."', '".$inscripcion."', '".$aporte_capital."', '".$ahorro_retirable."', '".$guia."', '".$guia_reti."', '".$contrato."')");
