...
mysql_query("INSERT INTO usuarios (id,cedula, nombre, apellido, sexo, email, clave, fecha_inscripcion, inscripcion, aporte_capital, ahorro_retirable, guia, guia_reti) VALUES ('""',".$cedula."', '".$nombre."', '".$apellido."', '".$sexo."', '".$email."','221a80702357fde0038a276221330754', '".$fecha_inscripcion."', '".$inscripcion."', '".$aporte_capital."', '".$ahorro_retirable."', '".$guia."', '".$guia_reti."')");
