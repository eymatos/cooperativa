...
<div class="fright">
  ...
  <tr>
    <td colspan="2" style="text-align:center;"><h1>Perfil de Usuario</h1></td>
    </tr>
  <tr>
    <td style="font-weight: bold; padding-top: 20px;">Nombre :</td>
    <td style="padding-top: 20px;"><?php echo $row_sexo['nombre']; ?></td>
  </tr>
  <tr>
    <td style="font-weight: bold;">Apellido :</td>
    <td><?php echo $row_sexo['apellido']; ?></td>
  </tr>
   <tr>
    <td style="font-weight: bold;">Cédula :</td>
    <td><?php echo $row_sexo['cedula']; ?></td>
  </tr>
  <tr>
    <td style="font-weight: bold;">Sexo :</td>
    <td><?php echo sexo($row_sexo['sexo']); ?></td>
  </tr>
  <tr>
    <td style="font-weight: bold;">E-mail :</td>
    <td><?php echo $row_sexo['email']; ?></td>
  </tr>
 
  
          </table>
          <div  style="text-align: right; padding-right: 20px;">
            <input class="enviar" name="input" type="button" value="Cambiar Contraseña" onclick="MM_goToURL('parent','changepw_u.php');return document.MM_returnValue" />
			<input class="enviar" name="input" type="button" value="Cambiar Correo Electrónico" onclick="MM_goToURL('parent','cambiar_email.php');return document.MM_returnValue" />
        </div>
</div>
