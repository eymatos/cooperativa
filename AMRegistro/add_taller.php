...
if($nombre && $apellido)
{
mysql_query("INSERT INTO $sitio (cedula, nombre, apellido, institucion) VALUES ('".$cedula."', '".$nombre."', '".$apellido."', '".$institucion."')");
echo "<div>".$nombre." ".$apellido." fue agregado al taller seleccionado";
}
