...
function encabezados(){
	echo " <div id='topright'class='fright'>
			...
			<div style='float:left;padding-left:5px;'>Ultima actualización, Febrero 25 2019</div>
        </div>";
}
function sidemenu(){
...
function retornoadmin(){
	echo "<div style='float:right;margin:10px;position:fixed;    bottom: 600px;
    right: 5px; '>
        	<a href='administrador.php'><img src='back.png' width='50'>Retornar</a>
        </div>";
}
