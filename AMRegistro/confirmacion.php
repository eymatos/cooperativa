...
if(isset($_GET['buscar']) && $_GET['buscar'] == 'Buscar'){
    ...
    if(!empty($totalRows)){
		...
		<tr>
			...
			<td><b>29 de marzo 2019</b></td>
			<td><b>30 de marzo 2019</b></td>
			<td><b>31 de marzo 2019</b></td>
			<td><b>Confirmar asistencia</b></td>
...
echo "<td>$fecha3</td>";
?>
<td><form action="confirmar.php" method="post" name="confirmar">
    <input type="hidden" name="confcedula" value="<?php echo $cedula;?>" />
	<select style="width:100%;margin:auto;text-align:center;" name="fecha">
<option value="29-03-2019">29-03-2019</option>
<option value="30-03-2019">30-03-2019</option>
<option value="31-03-2019">31-03-2019</option>
</select>
     <button type="submit" name="buscar" value="Confirmar" class="btn btn-default">
