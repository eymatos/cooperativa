...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "actualizar_u")) {
  $updateSQL = sprintf("UPDATE usuarios SET clave=%s WHERE id=%s",
...
<table width="100%" border="0" cellspacing="5" cellpadding="5" id="perfil1">
  <tr>
    <td colspan="2" id="encabezado">Cambio de Contraseña</td>
    </tr>
  <tr>
    <td width="27%" style="font-weight: bold; padding-top: 20px;">Nueva Contraseña :</td>
    <td width="73%" style="padding-top: 20px;"><input name="clave" type="password" />
      <input name="id" type="hidden" id="id" value="<?php echo $row_sexo['id']; ?>" /></td>
  </tr>
  </table>
          <div style="text-align: right; padding-right: 320px;"><input class="enviar" type="submit" value="Cambiar Contraseña" /></div>
