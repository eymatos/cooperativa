...
mysql_query("UPDATE `usuarios` SET `nombre` = '".$nombre."' WHERE `cedula` = '".$cedula."'") or die(mysql_error());
mysql_query("UPDATE `usuarios` SET `apellido` = '".$apellido."' WHERE `cedula` = '".$cedula."'") or die(mysql_error());
