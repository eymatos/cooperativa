...
<h1>Cargar archivos</h1>
	<form style="width:100%;" action="upload.php" method="POST" style="margin-top: 10px;" enctype="multipart/form-data" >
	<div class="formulario2" style="
    width: 49%;
    float: left;
	margin-right:2%;
">
		<span style="width:100%;" ><b>Nombre de carpeta</b> :</span>
		<span style="width:100%;"><input type="text" name="carpeta" class="form-control" required></span>
	</div>
	<div class="formulario2" style="
    width: 49%;
    float: left;
...
">
<span style="width:100%;"><b>Seleccionar documento</b> :</span>
<span style="width:100%;"><input name="archivo[]" type="file" class="form-control" required multiple></span>
	</div>
    ...
    padding-top: 30px;">
		<p style="
    text-align: center;
"><input class="btn btn-success" type="submit" value="Subir archivo" style="float: left;"></form>
<?php
...
for ($i=0; $i<=$num_archivos; $i++)
{
	...
	{
		 if(!is_dir("Zr6867TyPUiXLM8462KLQZADFXBGERTUIJKLMJKASDRTYasf5678/".$carpeta)){
    mkdir("Zr6867TyPUiXLM8462KLQZADFXBGERTUIJKLMJKASDRTYasf5678/".$carpeta, 0755);
  }
		$ruta = 'Zr6867TyPUiXLM8462KLQZADFXBGERTUIJKLMJKASDRTYasf5678/'.$carpeta.'/'.$_FILES['archivo']['name'][$i];
		if (file_exists($ruta))
		{
		echo "El archivo "."perfil_".$_FILES['archivo']['name'][$i]." ya existe<br>";
		}
		else
		{
		$guardado = $_FILES['archivo']['tmp_name'][$i];
		move_uploaded_file($guardado,$ruta);
		echo "El archivo "."perfil_".$_FILES ['archivo']['name'][$i]." se subio correctamente<br>";
