...
<form action="resetearpassword.php?sitio=<?php echo $sitio; ?>" method="POST">
<input type="text" name="sitio2" value="<?php echo $sitio?>" style="display:none;">
<br><br>

<input class="enviar" type="submit" value="Resetear Contraseña">
</form>
<?php @$cedula=$_POST['sitio2'];

if($cedula)
{	

mysqli_query("UPDATE usuarios SET clave='221a80702357fde0038a276221330754' WHERE cedula='$cedula'") or die(mysqli_error());
	
echo "La contraseña para ".$cedula." ha sido reiniciada";
