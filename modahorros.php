...
<section>     
<div id="menu"><?php sidemenu();
@$sitio=$_GET['sitio'];?></div>
...
<option value="ahorros_2021">2021</option>
<option value="ahorros_2020">2020</option>
<option value="ahorros_2019">2019</option>
<option value="ahorros_2018">2018</option>
<option value="ahorros_2017">2017</option>
<option value="ahorros_2016">2016</option>
<option value="ahorros_2015">2015</option>
<option value="ahorros_2014">2014</option>
<option value="ahorros_2013">2013</option>
<option value="ahorros_2012">2012</option>
<option value="ahorros_2011">2011</option>
</select>
<span><b>Seleccionar Mes:</b></span>
<select style="width:100%;margin:auto;text-align:center;" name="sitio3">
<option value="aporte_diciembre">Diciembre</option>
<option value="aporte_noviembre">Noviembre</option>
<option value="aporte_octubre">Octubre</option>
<option value="aporte_septiembre">Septiembre</option>
<option value="aporte_agosto">Agosto</option>
<option value="aporte_julio">Julio</option>
<option value="aporte_junio">Junio</option>
<option value="aporte_mayo">Mayo</option>
<option value="aporte_abril">Abril</option>
<option value="aporte_marzo">Marzo</option>
<option value="aporte_febrero">Febrero</option>
<option value="aporte_enero">Enero</option>
</select>
<span><b>Quiere comentar un mes?</b></span>
<select style="width:100%;margin:auto;text-align:center;" name="sitio4">
<option value="comentarios_diciembre">Diciembre</option>
<option value="comentarios_noviembre">Noviembre</option>
<option value="comentarios_octubre">Octubre</option>
<option value="comentarios_septiembre">Septiembre</option>
<option value="comentarios_agosto">Agosto</option>
<option value="comentarios_julio">Julio</option>
<option value="comentarios_junio">Junio</option>
<option value="comentarios_mayo">Mayo</option>
<option value="comentarios_abril">Abril</option>
<option value="comentarios_marzo">Marzo</option>
<option value="comentarios_febrero">Febrero</option>
<option value="comentarios_enero">Enero</option>
</select>
...
<span><b>Agregar comentario:</b></span>
