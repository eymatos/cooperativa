...
<div>
<p>Ha seleccionado a la persona de cédula <?php echo $sitio;?> que desea realizar?</p>
<table>
<tr>
<td style="padding:10px;">
<img src="verahorros.png" title="Ver ahorros por mes de los usuarios" width="75" height="auto">
</td>
<td style="padding:10px;">
<img src="resetpassword.png" title="Reiniciar contraseña de cuenta a la default coo123procon" width="75" height="auto">
</td>
</tr>
<tr>
<td style="padding:10px;width:75px;text-align:center;">
<a href="verahorros.php?sitio=<?php echo $sitio; ?>" title="Ver ahorros por mes de los usuarios">Ver Ahorros</a>
</td>
<td style="padding:10px;width:75px;text-align:center;">
<a href="resetearpassword.php?sitio=<?php echo $sitio; ?>" title="Reiniciar contraseña de cuenta a la default coo123procon">Resetear Password</a>
</td>
</tr>
