...
">
<?php retornoadmin();?> 
<h1>Cambiar nombre y apellido de usuario</h1>
<form action="modnombre.php?sitio=<?php echo $sitio;?>" method="POST">
<input type="text" name="cedula" value="<?php echo $sitio?>" style="display:none;">
<span><b>Nombre nuevo:</b></span>
<span style="margin-bottom:15px;"><input type="text" name="nombre"  style="margin-bottom:15px;"></span><br>
<span><b>Apellido nuevo:</b></span>
<span style="margin-bottom:15px;"><input type="text" name="apellido"  style="margin-bottom:15px;"></span><br>
<input class="enviar" type="submit" value="Aplicar cambio">
</form>
<?php
@$cedula=$_POST['cedula'];
@$nombre=$_POST['nombre'];
...
echo "Usted ha seleccionado a la persona de cédula $sitio";

if($cedula && $nombre && $apellido)
{	

mysqli_query("UPDATE `usuarios` SET `nombre` = '".$nombre."' WHERE `cedula` = '".$cedula."'") or die(mysqli_error());
mysqli_query("UPDATE `usuarios` SET `apellido` = '".$apellido."' WHERE `cedula` = '".$cedula."'") or die(mysqli_error());
 
	
echo "<br>El nuevo nombre es ".$nombre." y el nuevo apellido es ".$apellido." Aplicado a la persona seleccionada";
